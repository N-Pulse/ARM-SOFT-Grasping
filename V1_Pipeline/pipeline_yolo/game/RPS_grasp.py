...
def main():
    parser = argparse.ArgumentParser(
        description="Execute grasp sequence for RPS movements.")
    parser.add_argument(
        "--movement",
        choices=["rock", "paper", "scissors"],
        required=True,
        help="Movement type: rock, paper, or scissors")
    ...
    # Disconnect the bus only if args.cont is "false"
